<div>
    <div class="flex flex-col sm:flex-row p-4 justify-end items-center">
        <button
      ...
      <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100">
        <div
          ...
          <header class="flex flex-col justify-center items-center p-3 text-green-600">
            <h2 class="font-semibold text-2xl">Add Training</h2>
          </header>
          <main class="p-3 text-center">
            <form class="p-6 flex flex-col justify-center" wire:submit.prevent="submit">
                <div>
                ...
                <div x-data="imageViewer()">
                    <div class="flex flex-col">
                        ...
                        <div class="mb-2">
                            ...
                            {{-- @if ($fileName)
                                Photo Preview:
                                <img src="{{ Storage::url($this->fileName) }}">
                            @endif --}}
                            ...
                            <div class="flex w-full items-center justify-center bg-grey-lighter">
                                <label class="w-64 flex flex-col items-center uppercase cursor-pointer">
                                    ...
                                    <input type='file' class="hidden" id="imginput" accept="image/*" @change="fileChosen" wire:model="fileName" />
                                </label>
                            </div>  
                        </div>
                        @error('fileName')
                        <div class="flex justify-center items-center m-1 font-medium py-1 px-2 rounded-md text-red-100 bg-red-700 border border-red-700 ">
                            <div slot="avatar">
